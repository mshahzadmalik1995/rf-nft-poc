    ...
    try {
        ...
        if (userAssociateMissionData) {
            ...
            if (userAssociateMissionData.missionCompleted) {
                console.log("inside the transferproducerkafka");
                const message = {
                    contractAddress: contractAddress,
                    cryptoAddress: cryptoAddress,
                    tokenId: tokenId,
                    missionId: userAssociateMissionData.missionId,
                    userId: userAssociateMissionData.userId
                }
                console.log(message);
                ...
                kafkaConfig.produce("my-topic-nft-transer-producer", messages);
        ...
        return res.status(200).json(`Mission completion status pending`);
    } catch (e) {
