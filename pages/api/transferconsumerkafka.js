...
export default async function mintconsumerkafka(req, res) {
    try{
        console.log("Get invoked consumemintkafka"); 
        const kafkaConfig = new KafkaConfig("cddd-t", "gddd-t");

        kafkaConfig.consume("my-topic-nft-transer-consumer", async(value) => {
